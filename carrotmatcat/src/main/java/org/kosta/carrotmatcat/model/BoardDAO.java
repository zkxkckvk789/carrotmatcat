...
public class BoardDAO {
	...
	public ArrayList<PostVO> findPostList(Pagination pagination) throws SQLException{
		...
		try {
			...
			while(rs.next()) {
				list.add(new PostVO(rs.getLong("rnum"),rs.getString("article_title"),rs.getString("article_store_name"),rs.getLong("article_hits"),rs.getString("article_time_posted"),new MemberVO(null,null,rs.getString("member_nickname"))));
			}
		} finally {
	...
	public int getTotalPostCount() throws SQLException {
		...
		try {
			con = dataSource.getConnection();
			String sql = "select count(*) from carrotmatcat_board";
