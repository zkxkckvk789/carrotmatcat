...
<div class="container pt-3">
	...
	<table class="table table ">
		<thead>
			<tr
				style="text-align: left; color: white; border-bottom: dashed; font-size: 2em;">
				<th class="no">${postDetailView.articleFoodCategory}</th>
			</tr>
			<tr
				style="font-size: 1.1em; color: #aac414; background-color: white;">
		...
		<tbody>
			<tr style="background-color: white">
				<td colspan="6" style="height: 30vh;"><font size="4"><pre>${postDetailView.articleContent}</pre></font>
				</td>
			</tr>
			<c:if
				...
				<div>
					<button type="button" onclick="updatePostByNo()"
						style="color: gray; background-color: white; border: 2px solid white; border-radius: 50px;">수정</button>
					<button type="button" onclick="deletePostByNo()"
						style="color: gray; background-color: white; border: 2px solid white; border-radius: 50px;">삭제</button>
					<script>
				...
				<div class="article_content">
					<table class="table">
						...
						<tr>
							<td colspan="5"><font size="4"><pre>${postDetailView.articleContent}</pre></font>
							</td>
						</tr>
						</c:if>
						</tbody>
